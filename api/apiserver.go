...
import (
	...
	"github.com/crunchydata/postgres-operator/api/backupservice"
	"github.com/crunchydata/postgres-operator/api/cloneservice"
	"github.com/crunchydata/postgres-operator/api/clusterservice"
	"github.com/crunchydata/postgres-operator/api/policyservice"
	"github.com/crunchydata/postgres-operator/api/upgradeservice"
